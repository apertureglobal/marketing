# Aperture Global · 806 Willowdale Ct, Nashville, Tennessee · HTML5 display ads
...
|---|---:|---:|---:|---|
| 768x1024 | 539 KB | 467,391 B | 77% | Master unit |
| 1024x768 | 628 KB | 559,516 B | 90% | Landscape: the band runs to the top edge, 134 px row panel beneath (logo / rule / headline + rotating subline / CTA) |
| 480x320 | 266 KB | 194,576 B | 38% | The same row structure reduced |
| 970x250 | 305 KB | 231,347 B | 44% | Billboard |
| 320x480 | 209 KB | 133,302 B | 30% | Portrait, the master proportions at 320 wide |
| 300x600 | 233 KB | 158,136 B | 33% | Half page, 300x300 band |
...
Generated, never hand-edited. Editing a unit's `index.html` is reverted by the next rebuild.
    ...
    python3 kenburns_build.py --order "<order folder>" --overrides overrides/<slug>.json \
      --folder 806WillowdaleCt-Nashville-TN --clicktag-slug <lofty-slug> --photos <six, in order>

The builder lives in `~/Documents/Claude/aperture-digital-ads`. Running order of the stills:

1. `exterior-02.jpg`
2. `kitchen-05.jpg`
3. `master-bath-03.jpg`
4. `outdoor-12.jpg`
