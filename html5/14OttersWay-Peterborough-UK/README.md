# Aperture Global · 14 Otters Way, Hampton Water, Peterborough, PE7 8TX · HTML5 display ads
...
|---|---:|---:|---:|---|
| 768x1024 | 420 KB | 342,545 B | 60% | Master unit |
| 1024x768 | 564 KB | 491,177 B | 81% | Landscape: the band runs to the top edge, 134 px row panel beneath (logo / rule / headline + rotating subline / CTA) |
| 480x320 | 230 KB | 155,608 B | 33% | The same row structure reduced |
| 970x250 | 264 KB | 187,018 B | 38% | Billboard |
| 320x480 | 191 KB | 113,021 B | 27% | Portrait, the master proportions at 320 wide |
| 300x600 | 210 KB | 133,022 B | 30% | Half page, 300x300 band |
...
- Headline — **14 Otters Way**
- Sub 1 — **Hampton Water, Peterborough, PE7 8TX**
- Sub 2 — **5 bed | 3 bath | 2,793 sq ft**
- Sub 3 — **Listed by Krishan Mistry**
- CTA — **Schedule a viewing** (sentence case, per the Aperture standard)
- clickTag → `https://www.apertureglobal.com/14ottersway`
...
Generated, never hand-edited. Editing a unit's `index.html` is reverted by the next rebuild.
    ...
    python3 kenburns_build.py --order "<order folder>" --overrides overrides/<slug>.json \
      --folder 14OttersWay-Peterborough-UK --clicktag-slug <lofty-slug> --photos <six, in order>
