# Aperture Global · 10 Eton Thameside, 15 Brocas Street, Eton, SL4 6FB · HTML5 display ads
...
|---|---:|---:|---:|---|
| 768x1024 | 427 KB | 347,296 B | 61% | Master unit |
| 1024x768 | 550 KB | 474,704 B | 79% | Landscape: the band runs to the top edge, 134 px row panel beneath (logo / rule / headline + rotating subline / CTA) |
| 480x320 | 237 KB | 160,589 B | 34% | The same row structure reduced |
| 970x250 | 268 KB | 188,874 B | 38% | Billboard |
| 320x480 | 198 KB | 117,911 B | 28% | Portrait, the master proportions at 320 wide |
| 300x600 | 215 KB | 135,138 B | 31% | Half page, 300x300 band |
...
- Headline — **10 Eton Thameside**
- Sub 1 — **15 Brocas Street, Eton, SL4 6FB**
- Sub 2 — **3 bed | 3.5 bath | 1,887 sq ft**
- Sub 3 — **Listed by Toby Madden**
- CTA — **Schedule a viewing** (sentence case, per the Aperture standard)
- clickTag → `https://www.apertureglobal.com/10etonthameside`
...
Generated, never hand-edited. Editing a unit's `index.html` is reverted by the next rebuild.
    ...
    python3 kenburns_build.py --order "<order folder>" --overrides overrides/<slug>.json \
      --folder EtonThameside-Eton-UK --clicktag-slug <lofty-slug> --photos <six, in order>
