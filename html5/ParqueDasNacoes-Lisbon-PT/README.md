...
|---|---:|---:|---:|---|
| 768x1024 | 499 KB | 414,377 B | 71% | Master unit |
| 1024x768 | 596 KB | 513,941 B | 85% | Landscape: the band runs to the top edge, 134 px row panel beneath (logo / rule / headline + rotating subline / CTA) |
| 480x320 | 268 KB | 184,873 B | 38% | The same row structure reduced |
| 970x250 | 304 KB | 219,168 B | 43% | Billboard |
| 320x480 | 219 KB | 132,440 B | 31% | Portrait, the master proportions at 320 wide |
| 300x600 | 238 KB | 151,356 B | 34% | Half page, 300x300 band |
...
- Headline — **Parque das Nações**
- Sub 1 — **Lisbon Market District**
- Sub 2 — **4 bed | 5 bath | 4,478 sq ft**
- Sub 3 — **Listed by Liza Falcão de Sá & Charles Andrews**
- CTA — **Schedule a viewing** (sentence case, per the Aperture standard)
- clickTag → `https://www.apertureglobal.com/parquedasnacoes`
...
Generated, never hand-edited. Editing a unit's `index.html` is reverted by the next rebuild.
    ...
    python3 kenburns_build.py --order "<order folder>" --overrides overrides/<slug>.json \
      --folder ParqueDasNacoes-Lisbon-PT --clicktag-slug <lofty-slug> --photos <six, in order>

The builder lives in `~/Documents/Claude/aperture-digital-ads`. Running order of the stills:

1. `02_exterior-01_4096x2731.jpg`
2. `living-staged_48.jpg`
3. `kitchen-staged_46.jpg`
4. `01_view-01_cover_4096x2731.jpg`
