...
SRC = "/Users/kyleforeman/Documents/GitHub/APERTUREREPO/Untitled/html5/312MadisonSt-Nashville-TN"
...
for unit, name, share in UNITS:
    im = Image.open(f"{SRC}/APERTURE_312MadisonSt_{unit}_backup.jpg").convert("RGB")
