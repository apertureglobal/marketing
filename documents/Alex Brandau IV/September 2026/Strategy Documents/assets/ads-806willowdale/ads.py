#!/usr/bin/env python3
"""Copy the six backup stills into this document's own asset folder, each
...
SRC = "/Users/kyleforeman/Documents/GitHub/APERTUREREPO/Untitled/html5/806WillowdaleCt-Nashville-TN"
...
for unit, name, share in UNITS:
    im = Image.open(f"{SRC}/APERTURE_806WillowdaleCt_{unit}_backup.jpg").convert("RGB")
