...
SRC = "/Users/kyleforeman/Documents/GitHub/APERTUREREPO/Untitled/html5/14OttersWay-Peterborough-UK"
...
for size, name, share in UNITS:
    im = Image.open(f"{SRC}/APERTURE_14OttersWay_{size}_backup.jpg").convert("RGB")
